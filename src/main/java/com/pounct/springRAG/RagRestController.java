...
public class RagRestController {
    ...
    @PostMapping(value = "/ask", produces = MediaType.TEXT_PLAIN_VALUE) // on peut ajouter MediaType
    public String ask(String question) {
        ...
        // on peut ajouter comme les meta dadat ou trantement sur la reponse
        response += "metedata...";
        return response;
    }
